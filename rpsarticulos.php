...
<h6> Numero de articulos <input id='num' style='height: 20px; margin-right: 10px; margin-bottom:10px; width: 150px;' type='text' name='num' size='10' maxlength='30'> <a onclick="reportena();"><span id='glysearch' style="float: none;" class='glyphicon glyphicon-search'></span></a></h6>
 ...
 $meses[0]="ENERO";$meses[1]="FEBRERO";$meses[2]="MARZO";$meses[3]="ABRIL";$meses[4]="MAYO";$meses[5]="JUNIO";$meses[6]="JULIO";$meses[7]="AGOSTO";$meses[8]="SEPTIEMBRE";$meses[9]="OCTUBRE";$meses[10]="NOVIEMBRE";$meses[11]="DICIEMBRE";
           $auxmes=-1;
            ...
            if($num!=""){
                ...
                $buscar=mysql_query("SELECT P.cedula, P.nombre, COUNT(A.titulo) AS cant
                                    FROM ARTICULO AS A
                                    LEFT JOIN PROFESOR AS P ON P.LOGIN = A.LOGIN
                                    GROUP BY P.nombre") or die(mysql_error()); 
                ...
                echo "<tr><td>Cedula Profesor</td><td>Nombre Profesor</td><td>Cantidad de Articulos</td><td>%</td></tr>";
                do {        
                    if($busca[2]!=""){
                        if($busca['cant']>=$num){
                            $por=0;
                            ...
                            if($busca['cedula']!=NULL){
                                echo "<tr><td>".$busca['cedula']."</td><td>".$busca['nombre']."</td><td>".$busca['cant']."</td><td>".$por."</td></tr>";
                            }
                            else{
                                echo "<tr><td>ADMINISTRADOR</td><td>ADMINISTRADOR</td><td>".$busca['cant']."</td><td>".$por."</td></tr>";
                            }
                        }
                    }
                }while ($busca=mysql_fetch_array($buscar));
